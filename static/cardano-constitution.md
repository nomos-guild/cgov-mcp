...
TFGEN-02 (x - unquantifiable) Any changes to _txFeeFixed_ or _txFeeFixed_
...
MFRS-04 (x - unquantifiable) Any changes to _minFeeRefScriptCoinsPerByte_
**must** consider the implications of reducing the cost of a denial-of-service
...
MBBS-04 (~ - no access to existing parameter values) _maxBlockBodySize_
...
MBHS-03 (x - "largest valid header" is subject to change) _maxBlockHeaderSize_
...
MVS-05 (x - "sensible output" is subject to interpretation) _maxValueSize_
...
PCM-04 (~ - no access to _Plutus cost model_ parameters) A _cost model_
...
GAL-05 (~ - no access to existing parameter values) _govActionLifetime_
**must** be less than _dRepActivity_
...
- _governance voting thresholds_ (_dRepVotingThresholds[...],
